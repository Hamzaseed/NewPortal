  ...
  return (
    <section className="mb-12 grid grid-cols-1 gap-8 lg:grid-cols-12">
      <article className="lg:col-span-8">
        <AppLink to={`/news/${toArticleSlug(heroStory.title)}`}>
          <div className="group relative aspect-[16/9] overflow-hidden shadow-editorial">
