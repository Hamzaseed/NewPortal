  ...
  return (
    <section className="space-y-6">
      <div>
        ...
        <h1 className="mt-1 text-xl font-bold sm:text-2xl">{id ? 'Edit Article' : 'Create Article'}</h1>
        <p className="mt-1 text-xs text-slate-500 sm:text-sm">
          {id
            ? 'Update an existing story with the same editorial rhythm, imagery, and metadata structure used on the article page.'
